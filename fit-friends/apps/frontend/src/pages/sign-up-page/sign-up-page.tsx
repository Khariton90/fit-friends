            ...
            <div className="popup-form__form">
              <form method="post" autoComplete="off">
                <div className="sign-up">
                  ...
                  <Link className="btn sign-up__button" type="submit" to={Approute.CoachQuestion}>Продолжить</Link>
                  <Link className="btn sign-up__button" type="submit" to={Approute.UserQuestion}>Продолжить</Link>
                </div>
              </form>
            </div>
          </div>
